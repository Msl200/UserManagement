import { HTMLAttributes, InputHTMLAttributes, SelectHTMLAttributes, TextareaHTMLAttributes } from 'react';
import { dynamicOptionsType } from './apiTypes';
import { CustomEventHandlers } from './functionTypes';
import { ChildrenType, ColumnsType, ExtractFieldIds, FieldAsHTMLContainerTagType, FieldAutoCapitalizeType, FieldAutoCorrectType, FieldAutoFocusType, FieldCheckboxType, FieldClassNameType, FieldContainerType, FieldDatepickerType, FieldDefaultValueType, FieldDescriptionType, FieldDisabledType, FieldGridViewType, FieldGroupType, FieldIdType, FieldInputFileType, FieldInputType, FieldLabelType, FieldLayout, FieldPlaceholderType, FieldRadioType, FieldRequiredMessageType, FieldRequiredType, FieldSelectType, FieldSingleNegativeAnswerValue, FieldSinglePositiveAnswerValue, FieldSpacerType, FieldSpellCheckType, FieldStepType, FieldStyleType, FieldTextareaColsType, FieldTextareaRowsType, FieldTextareaType, FieldTypeType, FieldVisibilityType, FileAcceptType, FileFileTypesType, FileMaxSizeMBType, FileMinFilesType, FileMultipleType, FilePresignedUrlFnType, FilePreviewType, FileRenameFileType, FileStorageFormatType, FileStoreLocallyType, FileUploadHeadersType, FileUploadMethodType, FileUploadUrlType, GapType, HeightType, OptionsType, WidthType } from './primitiveTypes';
...
export interface TextFieldType extends BaseField, Omit<InputHTMLAttributes<HTMLInputElement>, "required" | "disabled"> {
    type: FieldInputType;
...
export interface DateFieldType extends BaseField, Omit<InputHTMLAttributes<HTMLInputElement>, "required" | "disabled"> {
    type: FieldDatepickerType;
}
export interface SelectFieldType extends BaseField, Omit<SelectHTMLAttributes<HTMLSelectElement>, "required" | "disabled"> {
...
export interface CheckboxFieldType extends BaseField, Omit<SelectHTMLAttributes<HTMLSelectElement>, "required" | "type" | "disabled"> {
...
export interface TextareaFieldType extends BaseField, Omit<TextareaHTMLAttributes<HTMLTextAreaElement>, "required" | "disabled"> {
...
export interface InputFileType extends BaseField, Omit<InputHTMLAttributes<HTMLInputElement>, "required" | "disabled" | "accept"> {
...
export interface BaseContainerField<T extends FormFieldType[]> extends Omit<BaseField, "fields"> {
...
export type FormFieldType = BaseField | TextFieldType | DateFieldType | SelectFieldType | RadioFieldType | CheckboxFieldType | GroupFieldType | GridViewFieldType | ContainerFieldType | TextareaFieldType | SpacerFieldType | InputFileType;
