...
export type SupportedArray = Array<SupportedPrimitive | SupportedObject | SupportedArray>;
export type SupportedObject = {
    [key: string]: SupportedPrimitive | SupportedArray | SupportedObject;
};
export type SupportedTypes = SupportedPrimitive | SupportedArray | SupportedObject;
...
export type FunctionOrValue<T extends SupportedTypes> = T | ComputedValue<T> | ((context: FieldPropContext) => T);
...
export type TFieldVisibility = boolean | {
...
export type FieldSinglePositiveAnswerValue = string;
export type FieldSingleNegativeAnswerValue = string;
...
export type FieldAutoCapitalizeType = "on" | "off" | "sentences" | "words" | "characters" | "none";
export type FieldSpellCheckType = boolean;
export type FieldAutoFocusType = boolean;
export type FieldStepType = number;
export type FieldInputType = "text" | "number" | "email" | "password" | "url" | "tel" | "search";
...
export type FieldAsHTMLContainerTagType = "div" | "section" | "article" | "main" | "header" | "footer";
...
export type ExtractFieldIds<T extends {
    fieldId: string;
}[]> = T[number]["fieldId"];
...
export type APITransformResponseType = (response: any) => {
    label: string;
    value: any;
}[] | string[];
...
export type FileStorageFormatType = "file" | "fileList" | "base64" | "blobUrl" | "arrayBuffer" | "remoteUrl" | "metadata";
